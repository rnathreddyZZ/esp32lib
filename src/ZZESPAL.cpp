...
String HalClass::getShortId( void )
{
...
String HalClass::getLongId( int base )
{
  ...
  /* This probably needs to be platform specific, assumes the
     ChipID is a MAC address, only true on the ESP32 */
  if( (10 == base) || (16 == base) )
  {
